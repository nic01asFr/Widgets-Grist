...
import { defaultLayerVisible, applyAtlas3dFromRows } from './grist-sync.js?v=1.6.2';
import { applyManifestControlsToLayer } from './manifest-binding.js?v=1.6.2';
