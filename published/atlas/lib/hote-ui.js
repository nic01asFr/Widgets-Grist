...
import { capacites, creerClient } from './data-client.js?v=1.6.2';
import { installerAdaptateur } from './grist-adapter.js?v=1.6.2';
import { listerScenesAtlas } from './decouverte.js?v=1.6.2';
import {
