...
import { capacites, creerClient } from './data-client.js?v=1.6.4';
import { installerAdaptateur } from './grist-adapter.js?v=1.6.4';
import { listerScenesAtlas } from './decouverte.js?v=1.6.4';
import {
