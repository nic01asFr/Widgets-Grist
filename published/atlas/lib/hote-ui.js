...
import { capacites, creerClient } from './data-client.js?v=1.6.6';
import { installerAdaptateur } from './grist-adapter.js?v=1.6.6';
import { listerScenesAtlas } from './decouverte.js?v=1.6.6';
import {
